...
export default function Search(props) {
  ...
  useEffect(() => {
    (async () => {
      const allSearchData = await getSearchData()
      setTags(allSearchData.data.tags)
      setBrands(allSearchData.data.brand)
      setPriceArr(allSearchData.data.priceArr)
      setCountryList(allSearchData.data.countries)
    })()
  }, [])
